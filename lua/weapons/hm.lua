...
SWEP.PrintName = "XM8"
SWEP.Author = "Izhevsk nt"
SWEP.Instructions = "The XM8 was based on the rifle module of Alliant Techsystems's XM29 OICW project, of which the weapon mechanisms were the responsibility of H&K"
SWEP.Category = "Weapons - Assault Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_rif_ak47.mdl"
SWEP.WorldModelFake = "models/weapons/arccw/c_xm8.mdl"

SWEP.FakePos = Vector(-15, 5.2, 3.5)
...
SWEP.Primary.Sound = {"weapons/arccw_xm8/fire.wav", 85, 90, 100}
SWEP.Primary.SoundFP = {"weapons/arccw_xm8/fire.wav", 85, 90, 100}
...
SWEP.WepSelectIcon2 = Material("entities/midnights_gso_xm8.png")
SWEP.WepSelectIcon2box = true
SWEP.IconOverride = "entities/midnights_gso_xm8.png"
...
SWEP.availableAttachments = {
    sight = {
        ...
        ["mount"] = { ["picatinny"] = Vector (-20, -0.4, -3) }, 
        ["mountAngle"] = { ["picatinny"] = Angle(0, 0, 270) },
        
        
        
        [1] = {"optic2", Vector(0, -1.6, -1), {}}, -- Burris Fullfield TAC30
        [2] = {"optic5", Vector(0, -1.6, -1.3), {}}, -- Vortex Razor HD Gen 2
        [3] = {"optic6", Vector(0, -1.5, -1.6), {}},   -- Leupold Mark 4
        
        
    },
    --grip = {
       -- ["mountType"] = "picatinny",
       -- ["mount"] = Vector(-18, -0.2, -1.5),                 
       -- ["mountAngle"] = Angle(0, 0, 270)                     
    --},
   -- barrel = {
    --    [1] = {"supressor4", Vector(-4, -0.2, -1), {}},
    --    [2] = {"supressor6", Vector(0, 0, -1), {}},
