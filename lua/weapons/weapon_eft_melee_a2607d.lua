...
SWEP.Instructions = "The Bars A-2607 knife, forged of Damascus steel with a wenge handle and brass guard."
...
if CLIENT then
	SWEP.WepSelectIcon = Material("entities/arc9_eft_melee_a2607d.png")
	SWEP.IconOverride = "entities/arc9_eft_melee_a2607d.png"
