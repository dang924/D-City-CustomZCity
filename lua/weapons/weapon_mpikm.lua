...
SWEP.PrintName = "MPi-KM"
SWEP.Author = "VEB Geräte- und Werkzeugbau Wiesa"
SWEP.Instructions = "The MPi-KM is a East German license-manufactured version of the Soviet AKM assault rifle chambered in 7.62x39."
SWEP.Category = "Weapons - Assault Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_rif_ak47.mdl"
SWEP.WorldModelFake = "models/weapons/v_dmi_mpi-km.mdl"
...
SWEP.WepSelectIcon2 = Material("vgui/entities/hud/tfa_mpi-km")
SWEP.IconOverride = "vgui/entities/hud/tfa_mpi-km"
SWEP.ScrappersSlot = "Primary"
SWEP.availableAttachments = {
	barrel = {
		[1] = {"supressor1", Vector(0,0,0), {}},
		[2] = {"supressor6", Vector(0,0.2,-0.2), {}},
		["mount"] = Vector(-2.6,0.4,0.2),
...
SWEP.LocalMuzzlePos = Vector(27.6,0.0,2.6)
SWEP.LocalMuzzleAng = Angle(0.8,-0.06,0)
SWEP.WeaponEyeAngles = Angle(0,0,0)

SWEP.PPSMuzzleEffect = "pcf_jack_mf_mrifle1" -- shared in sh_effects.lua

SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(0, -0.0132, 5.0857)
