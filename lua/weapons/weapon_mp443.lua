...
function SWEP:OnCantReload()
	...
	self:PlayAnim("magcheck1",3,false,function(self)
...
SWEP.AnimsEvents = {
	["magcheck1"] = {
		[0.1] = function(self)
			self:EmitSound("weapons/darsu_eft/mp443/grach_mag_out.ogg",55)
		end,
		--[0.35] = function(self)
			--self:EmitSound("arc9_eft_shared/weapon_generic_spin8.ogg",55)
		--end,
		[0.5] = function(self)
			self:EmitSound("arc9_eft_shared/weapon_generic_rifle_spin8.ogg",55)
		end,
		[0.75] = function(self)
			self:EmitSound("weapons/darsu_eft/mp443/grach_mag_in.ogg",55)
		end,
	},
}	
...
SWEP.SupressedSound = {"weapons/darsu_eft/mp443/grach_fire_outdoor_close2.wav", 75, 90, 100}
SWEP.Primary.SoundEmpty = {"weapons/darsu_eft/mp443/grach_trigger_hammer.wav", 75, 100, 105, CHAN_WEAPON, 2}
...
SWEP.DeploySnd = {"arc9_eft_shared/pm_draw.ogg", 55, 100, 110}
...
SWEP.lengthSub = 5
SWEP.DistSound = "weapons/darsu_eft/mp443/grach_fire_indoor_distant.wav"
...
function SWEP:DrawPost()
	...
	if CLIENT and IsValid(wep) then
		...
		wep:ManipulateBonePosition(110,Vector(-0,1.5*self.shooanim ,0 ,0 ),false)
	end
end
