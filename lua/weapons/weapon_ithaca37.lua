...
SWEP.WorldModelFake = "models/weapons/arc9_doi/c_ithaca.mdl"
SWEP.FakeScale = 0.95

SWEP.FakePos = Vector(-3.5, 2.5, 7.5)
...
SWEP.WepSelectIcon2 = Material("vgui/hud/tfa_ithaca_m37")
SWEP.IconOverride = "vgui/hud/tfa_ithaca_m37"

SWEP.LocalMuzzlePos = Vector(29,-0.07,4.8)
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(0, -0.0857, 5.6757)
...
SWEP.holsteredPos = Vector(2, 8.2, -8)
...
SWEP.AnimsEvents = {
	["base_reload_insert"] = {
		[0.1] = function(self, mdl)
			self:EmitSound("weapons/remington_870/870_insertshell_"..math.random(1,3)..".wav")
			mdl:ManipulateBoneScale(mdl:LookupBone("shell_2"), Vector(1, 1, 1))
			--
	...
	["base_reload_end"] = {
		[0.0] = function(self, mdl)
			mdl:ManipulateBoneScale(mdl:LookupBone("shell_2"), vector_origin)
		end,
	},
	["base_fire_cock_2"] = {
		[0.0] = function(self)
