...
SWEP.PrintName = "TKPD"
SWEP.Author = "SniperArms Dynamics"
SWEP.Instructions = "The TKPD is a modernized SVDK chambered in 9.3x64mm Brenneke, commissioned by a certain Russian PMC. The weapon is noted for high accuracy and effectively suppresses targets at medium ranges."
SWEP.Category = "Weapons - Sniper Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_snip_g3sg1.mdl"
SWEP.WorldModelFake = "models/weapons/arc9/darsu_eft/c_tkpd.mdl"
...
SWEP.FakeBodyGroups = "01121111111"

function SWEP:OnCantReload()
	--inspect1
	--print("huy")
	if self.Inspecting and self.Inspecting > CurTime() then return end
	self.Inspecting = CurTime() + 4.8
	self:PlayAnim("check_0",4.8,false,function(self)
...
SWEP.AnimsEvents = {
	["check_0"] = {
		...
		[0.3] = function(self)
			self:EmitSound("weapons/tfa_ins2/svd/svd_magout.wav",55)
		end,
		[0.5] = function(self)
			self:EmitSound("weapons/movement/weapon_movement3.wav",55)
		end,
		[0.75] = function(self)
			self:EmitSound("weapons/tfa_ins2/sks/sks_magin.wav",55)
		end,
	},
}
...
SWEP.FakeEmptyReloadSounds = {
	...
	[0.3] = "weapons/tfa_ins2/svd/svd_magout.wav",
	[0.42] = "weapons/tfa_ins2/universal/uni_weapon_draw.wav",
	--[0.37] = "weapons/m4a1/m4a1_magrelease.wav",
	[0.65] = "weapons/tfa_ins2/sks/sks_magin.wav",
...
if CLIENT then
	SWEP.FakeReloadEvents = {
		...
		[0.31] = function( self, timeMul )
			if self:Clip1() < 1 then
				hg.CreateMag( self, Vector(20,0,10), nil, true )
...
SWEP.Primary.Ammo = "9.3x64mm Brenneke"
SWEP.Primary.Cone = 0
...
SWEP.availableAttachments = {
	sight = {
		["mount"] = { ironsight = Vector(-29.5, 1.5, -0.3), picatinny = Vector(-27.8, 1.5, -0.3)},
		["mountType"] = {"picatinny", "ironsight"},
	},
	underbarrel = {
			[1] = {"laser5", Vector(0.0,0.2,0.35), {}},

		["mount"] = {["picatinny_small"] = Vector(3.5, -0.2, -2.5),["picatinny"] = Vector(5.5,0.5,-0.3)},
		["mountAngle"] = {["picatinny_small"] = Angle(-1, -0.0, 180),["picatinny"] = Angle(0.0, 0.25, 0)},
		["mountType"] = {"picatinny_small","picatinny"},
		["noblock"] = true,
	},
	grip = {
		["mount"] = Vector(0 + 5.3 - 6, -0.75 + 1, -0.3),
		["mountType"] = "picatinny"
	},
}
...
SWEP.LocalMuzzlePos = Vector(28,0.45,3.58)
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(0, 0.445, 5.7054)
SWEP.RHandPos = Vector(-8, -2, 6)
SWEP.LHandPos = Vector(6, -3, 1)
SWEP.AimHands = Vector(-10, 1.8, -6.1)
SWEP.SprayRand = {Angle(0.07, -0.15, 0), Angle(-0.15, 0.065, 0)}
