...
SWEP.Instructions = "The GSh-18 is a 9mm semi-automatic pistol developed by the KBP Instrument Design Bureau in Tula during the 1990s."
...
SWEP.WorldModelFake = "models/weapons/v_gsh18_request.mdl" // МОДЕЛЬКИ ЧУТЬ ПОПОЗЖЕ ЗАЛЬЮ
//SWEP.FakeScale = 3.5
