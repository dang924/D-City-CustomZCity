...
SWEP.PrintName = "Superfors Hammer"
SWEP.Instructions = "The hammer is coated with urethane which provides a 'thud' using steel balls to cushion the impact and reduce the vibration recoil to the handle."
