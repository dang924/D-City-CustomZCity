...
SWEP.WorldModelFake = "models/weapons/v_ins_pm9.mdl"
//SWEP.FakeScale = 1.2
//SWEP.ZoomPos = Vector(0, -0.0027, 4.6866)
SWEP.FakePos = Vector(-9.0, 3, 5.0)
SWEP.FakeAng = Angle(0, 0, 0)
SWEP.AttachmentPos = Vector(1,-0.0,-0.0)
...
SWEP.FakeReloadEvents = {
	...
	[0.35] = function( self ) 
		if CLIENT and self:Clip1() < 1 then
			hg.CreateMag( self, Vector(0,35,0) )
...
SWEP.WepSelectIcon2 = Material("vgui/hud/tfa_ins2_pm9")
SWEP.IconOverride = "vgui/hud/tfa_ins2_pm9"
...
SWEP.LocalMuzzlePos = Vector(14.328,0.45,2.3)
SWEP.LocalMuzzleAng = Angle(-0.55,-0.026,0)
...
SWEP.Primary.Wait = 0.044

SWEP.availableAttachments = {
	barrel = {
		[1] = {"supressor4", Vector(0,0,0), {}},
		[2] = {"supressor6", Vector(2.4,0.3,0), {}},
		["mount"] = Vector(-4.1,0.4,0.02),
	},
	sight = {
		["mount"] = Vector(-13, 1.2, 0.06),
		["mountType"] = "picatinny",
		["empty"] = {"empty", {}},
		["removehuy"] = {},
	},
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(0, 0.3922, 3.8596)
SWEP.RHandPos = Vector(1, -1, 0)
SWEP.LHandPos = false
SWEP.Spray = {}
for i = 1, 32 do
	SWEP.Spray[i] = Angle(-0.01 - math.cos(i) * 0.01, math.cos(i * 8) * 0.01, 0) * 0.6
end
...
function SWEP:DrawPost()
	...
	if CLIENT and IsValid(wep) then
		...
		wep:ManipulateBonePosition(2,Vector(-0.8*self.shooanim ,0 ,0 ),false)
	end
end
