...
SWEP.PrintName = "CQB 11"
SWEP.Author = "BCM Rifle Co."
...
SWEP.WorldModelFake = "models/weapons/arc9/mk1.mdl" -- Контент инсурги https://steamcommunity.com/sharedfiles/filedetails/?id=3437590840 models/weapons/zcity/v_416c.mdl
--uncomment for funny
...
SWEP.lmagpos2 = Vector(0,-1.5,2.8)
...
SWEP.WepSelectIcon2 = Material("entities/arc9_ron_mk1.png")
SWEP.WepSelectIcon2box = true
SWEP.IconOverride = "entities/arc9_ron_mk1.png"

SWEP.LocalMuzzlePos = Vector(13.1,1.08,2.83)
...
SWEP.availableAttachments = {
	...
	sight = {
		...
		["mount"] = {ironsight = Vector(-9 - 4.5, 1.55 - 0.4, -0.1), picatinny = Vector(-8.5 - 6, 1.6 - 0.45, -0.11)},
...
function SWEP:DrawPost()
	...
	if CLIENT and IsValid(wep) then
		...
		wep:ManipulateBonePosition(40,Vector(0 ,1.5*self.shooanim ,0 ),false)
	end
end
