...
SWEP.PrintName = "HK VP9"
SWEP.Author = "Heckler & Koch"
SWEP.Instructions = "The Heckler & Koch VP9 is a polymer-framed semi-automatic striker-fired handgun. The VP designation in the name refers to Volkspistole. The 9 stands for the caliber designation of 9x19 mm."
SWEP.Category = "Weapons - Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_pist_elite_single.mdl"
SWEP.WorldModelFake = "models/weapons/v_casgirl_vp9.mdl"

SWEP.FakePos = Vector(-13, 2.5, 5)
SWEP.FakeAng = Angle(0, 0, 0)
SWEP.AttachmentPos = Vector(0,-0.1,0)
SWEP.AttachmentAng = Angle(0,90,0)
SWEP.ZoomPos = Vector(0, 0.0132, 3.7607)
...
SWEP.WepSelectIcon2 = Material("vgui/hud/tfa_ins2_vp9_mlg")
SWEP.IconOverride = "vgui/hud/tfa_ins2_vp9_mlg"
...
SWEP.LocalMuzzlePos = Vector(3.75,0.05,3.33)
...
SWEP.availableAttachments = {
	barrel = {
		...
		[2] = {"supressor6", Vector(2.2,0.6,-0.0), {}},
		--[3] = {"supressor3", Vector(0,0.2,0), {}},
		["mount"] = Vector(-0.26,0.42,0.05),
	},
	underbarrel = {
		[1] = {"laser5", Vector(0.45,0.1,0.2), {}},

		["mount"] = Vector(12.8, 0.9, -0.97),
		["mountAngle"] = Angle(0.15, 0.9, -90),
...
function SWEP:DrawPost()
	...
	if CLIENT and IsValid(wep) then
		...
		wep:ManipulateBonePosition(67,Vector(0 ,0.65*self.shooanim ,0 ),false)
	end
end
