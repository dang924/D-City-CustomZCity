...
SWEP.PrintName = "USAS"
SWEP.Author = "South-Korea"
SWEP.Instructions = "The USAS-12 (Universal Sporting Automatic Shotgun 12 gauge) is an automatic shotgun manufactured in South Korea by Daewoo Precision Industries since the 1980s."
SWEP.Category = "Weapons - Shotguns"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_rif_m4a1.mdl"
SWEP.WorldModelFake = "models/weapons/arccw/eap/c_usas.mdl"
//PrintAnims(Entity(1):GetActiveWeapon():GetWM())
--uncomment for funny
SWEP.FakePos = Vector(-21, 3.3, 10.5)
SWEP.FakeAng = Angle(1.3, 0, 0)
SWEP.AttachmentPos = Vector(37,5,10)
...
SWEP.WepSelectIcon2 = Material("entities/arccw_eap_usas.png")
SWEP.IconOverride = "entities/arccw_eap_usas.png"
...
SWEP.Primary.Sound = {"weapons/arccw/eap/usas/suppressed-3.wav", 80, 70, 75}
