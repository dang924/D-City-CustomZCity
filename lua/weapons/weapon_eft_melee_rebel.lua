...
SWEP.Instructions = "A perfectly balanced ice axe, the tip is made of a single piece of hardened metal."
SWEP.Category = "Weapons - EFT Melee"
SWEP.Spawnable = true
SWEP.AdminOnly = false

SWEP.WorldModel = "models/weapons/arc9/darsu_eft/w_melee_rebel_axe.mdl"
SWEP.WorldModelReal = "models/weapons/arc9/darsu_eft/c_melee_rebel_axe.mdl"
SWEP.ViewModel = ""
