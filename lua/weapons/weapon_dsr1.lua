...
SWEP.PrintName = "AMP DSR-1"
SWEP.Author = "DSR-Precision GmbH"
...
SWEP.WorldModelFake = "models/weapons/c_ins2_warface_amp_dsr1.mdl"

SWEP.FakePos = Vector(-8.5, 3.5, 6)
...
SWEP.FakeReloadSounds = {
	...
	[0.45] = "weapons/tfa_ins2/m4a1/m4a1_magrelease.wav",
	[0.5] = "weapons/barrett_m98b/m98b_clipout.wav",
	[0.6] = "weapons/aks74u/aks_magout_rattle.wav",
	[0.85] = "weapons/barrett_m98b/m98b_clipin.wav",
}
...
SWEP.AnimsEvents = {
	["base_fire_end"] = {
		...
		[0.4] = function(self)
			self:EmitSound("weapons/m40a1/m40a1_boltforward.wav", 45, math_random(110, 115))
		end,
		[0.6] = function(self)
			self:EmitSound("weapons/tfa_ins2/k98/mosin_boltlatch.wav", 45, math_random(110, 115))
		end
	}
}
...
SWEP.WepSelectIcon2 = Material("vgui/hud/tfa_ins2_warface_amp_dsr1")
SWEP.IconOverride = "vgui/hud/tfa_ins2_warface_amp_dsr1"
SWEP.weight = 5.5
...
SWEP.availableAttachments = {
	sight = {
		["mount"] = {picatinny = Vector(-25.7, 1, -0.00), ironsight = Vector(-26.3, 1.0, -0.03)},
	...
	underbarrel = {
		...
		["mount"] = {["picatinny_small"] =Vector(1.6, -2.3, -1.00),["picatinny"] = Vector(4.5,-3.1,0)},
		["mountAngle"] = {["picatinny_small"] = Angle(-0.05, -1.1, 90),["picatinny"] = Angle(-0.0, -0.55, 180)},
...
SWEP.LocalMuzzlePos = Vector(27,1.1,3.65)
...
SWEP.bipodsub = 15
SWEP.RestPosition = Vector(15, 1, 5.6)
...
function SWEP:ModelCreated(model)
	model:ManipulateBoneScale(105, vector_origin)
end
