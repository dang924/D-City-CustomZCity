...
SWEP.PrintName = "O.C.I.P.R. Type 2"
SWEP.Author = "Universal Union"
SWEP.Instructions = "O.C.I.P.R. (Overwatch Command Issue Pulse Rifle) is a Dark Energy/pulse-powered assault rifle.\n\nRate of fire 500 rounds per minute"
SWEP.Category = "Weapons - Assault Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/ocipr/w_ocipr.mdl"
SWEP.WorldModelFake = "models/weapons/rnd/irifle.mdl" -- Контент инсурги https://steamcommunity.com/sharedfiles/filedetails/?id=3437590840 
--uncomment for funny
--а еще надо настраивать заново zoompos
SWEP.FakePos = Vector(25, -5.5, 8.4)
...
SWEP.FakeReloadSounds = {
	[0.35] = "ar1/ar2_reload_rotate.wav",
	[0.20] = "weapons/hmcd_ar2/ar2_magout.wav",
	[0.75] = "weapons/hmcd_ar2/ar2_magin.wav",
	[0.57] = "ar1/ar2_reload_push.wav"
...
SWEP.Primary.Sound = {"ar1/wpn_combine_ar_fire_body_0"..math_random(1,4)..".wav", 85, 90, 100}
...
SWEP.WepSelectIcon2 = Material("sprites/weapons/ordrif")
SWEP.IconOverride = "entities/tfa_ocipr.png"
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(0, 3.3445, 6.102)
SWEP.Spray = {}
for i = 1, 25 do
...
SWEP.holsteredPos = Vector(5, 12, -3)
SWEP.holsteredAng = Angle(210, 0, 160)

SWEP.LocalMuzzlePos = Vector(-3.800,-2.5,3.382)
SWEP.LocalMuzzleAng = Angle(0.4,180.5,0)
