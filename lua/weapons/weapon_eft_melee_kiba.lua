...
SWEP.Instructions = "A tactical tomahawk, multitool and breaching tool, all-in-one solution."
...
SWEP.WorldModelReal = "models/weapons/arc9/darsu_eft/c_melee_kiba_axe.mdl"
...
if CLIENT then
	SWEP.WepSelectIcon = Material("entities/arc9_eft_melee_kiba.png")
	SWEP.IconOverride = "entities/arc9_eft_melee_kiba.png"
