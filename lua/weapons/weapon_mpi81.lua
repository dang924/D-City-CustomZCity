...
SWEP.WorldModelFake = "models/weapons/v_coldwar_mpi81.mdl"
SWEP.FakePos = Vector(-16, 2.8, 6.9)
...
SWEP.FakeReloadSounds = {
	...
	[0.36] = "weapons/mp40/handling/mp40_magrelease.wav",
	[0.4] = "weapons/mp40/handling/mp40_magout.wav",
	--[0.34] = "weapons/ak74/ak74_magout_rattle.wav",
	[0.60] = "weapons/universal/uni_crawl_l_02.wav",
	[0.77] = "weapons/mp40/handling/mp40_magin.wav",
...
SWEP.FakeEmptyReloadSounds = {
	...
	--[0.34] = "weapons/ak74/ak74_magout_rattle.wav",
	[0.80] = "weapons/universal/uni_crawl_l_02.wav",
	[0.26] = "weapons/mp40/handling/mp40_magrelease.wav",
	[0.30] = "weapons/mp40/handling/mp40_magout.wav",
	[0.65] = "weapons/mp40/handling/mp40_magin.wav",
	[0.45] = "weapons/universal/uni_crawl_l_05.wav",
	[0.85] = "weapons/mp40/handling/mp40_boltback.wav",
	[0.88] = "weapons/tfa_ins2/cz805/boltforward.wav",
	...
	SWEP.FakeReloadEvents = {
		[0.31] = function( self ) 
			if self:Clip1() < 1 then
				hg.CreateMag( self, Vector(0,30,20) )
				self:GetWM():ManipulateBoneScale(74, vector_origin)
				self:GetWM():ManipulateBoneScale(75, vector_origin)
				self:GetWM():ManipulateBoneScale(76, vector_origin)
			end
		end,
		[0.45] = function( self ) 
			if self:Clip1() < 1 then
				self:GetWM():ManipulateBoneScale(74, vector_full)
...
SWEP.WepSelectIcon2 = Material("vgui/hud/tfa_coldwar_mpi81")
SWEP.IconOverride = "vgui/hud/tfa_coldwar_mpi81"
SWEP.weight = 1.4
...
SWEP.availableAttachments = {
	barrel = {
		...
		[2] = {"supressor6", Vector(2.25,0.2,-0.1), {}},
		["mount"] = Vector(-1.53,0.7,-0.05),
	},
}
SWEP.ReloadSoundes = {
	"none",
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(0, 0.1285, 5.1747)
SWEP.RHandPos = Vector(-15, 0, 3)
SWEP.LHandPos = false
SWEP.Spray = {}
for i = 1, 25 do
	SWEP.Spray[i] = Angle(-0.01 - math.cos(i) * 0.01, math.cos(i * 5) * 0.01, 0) * 0.7
end

SWEP.LocalMuzzlePos = Vector(10.906,0.15,3.4)
...
SWEP.holsteredPos = Vector(-5.6, 0, 1)
SWEP.holsteredAng = Angle(210, 170, 110)
...
function SWEP:DrawPost()
	...
	if CLIENT and IsValid(wep) then
		...
		wep:ManipulateBonePosition(61,Vector(0 ,-0.75*self.shooanim ,0 ),false)
	end
end
