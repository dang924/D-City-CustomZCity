...
SWEP.Instructions = "The Heckler & Koch P7 is a German 9×19mm semi-automatic pistol designed by Helmut Weldle and produced from 1979 to 2008 by Heckler & Koch GmbH"
SWEP.Category = "Weapons - Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_pist_fiveseven.mdl"
SWEP.WorldModelFake = "models/weapons/hk_p7.mdl"
SWEP.FakePos = Vector(-16, 2.55, 2.65)
...
SWEP.ZoomPos = Vector(0, 0.4252, 1.9117)
SWEP.RHandPos = Vector(-4, 0, -3)
SWEP.LHandPos = false
SWEP.SprayRand = {Angle(-0.05, -0.05, 0), Angle(-0.08, 0.05, 0)}
...
SWEP.availableAttachments = {
	barrel = {
		...
		[2] = {"supressor6", Vector(2.5,0.55,0), {}},
...
function SWEP:DrawPost()
	...
	if CLIENT and IsValid(wep) then
		...
		wep:ManipulateBonePosition(44,Vector(-0.1*self.shooanim, -0.57*self.shooanim,0 ),false)
		wep:ManipulateBonePosition(45,Vector(0.02*self.shooanim, 0.2*self.shooanim,0 ),false)
	end
end
...
SWEP.LocalMuzzlePos = Vector(2.4,0.44,1.4)
