...
SWEP.Instructions = "The so-called \"Item 6Kh5\" is a bayonet knife adopted in 1989 as a standard-issue for use with AK-74 assault rifles."
SWEP.Category = "Weapons - EFT Melee"
SWEP.Spawnable = true
SWEP.AdminOnly = false

SWEP.WorldModel = "models/weapons/arc9/darsu_eft/w_melee_6x5.mdl"
SWEP.WorldModelReal = "models/weapons/arc9/darsu_eft/c_melee_6x5.mdl"
...
SWEP.weaponAng = Angle(160,135,-20)
...
SWEP.AttackSwing = "weapons/darsu_eft/melee/hammer_swing1.ogg" --!! заменить звуки
