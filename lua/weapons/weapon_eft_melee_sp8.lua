...
SWEP.Instructions = "SP-8 is a survival machete made of a single piece of high carbon steel. Manufactured by Ontario Knife Company."
...
SWEP.WorldModel = "models/weapons/arc9/darsu_eft/w_melee_sp8-8_lod0www.mdl"
SWEP.WorldModelReal = "models/weapons/arc9/darsu_eft/c_melee_sp8.mdl"
...
if CLIENT then
	SWEP.WepSelectIcon = Material("entities/arc9_eft_melee_sp8.png")
	SWEP.IconOverride = "entities/arc9_eft_melee_sp8.png"
