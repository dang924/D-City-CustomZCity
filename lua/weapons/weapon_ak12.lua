...
SWEP.Instructions = "The AK-12 is a Russian gas-operated assault rifle chambered in 5.45x39mm designed and manufactured by the Kalashnikov Concern, making it the fifth generation of Kalashnikov rifles."
SWEP.Category = "Weapons - Assault Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_rif_ak47.mdl"
SWEP.WorldModelFake = "models/weapons/arc9/c_ur_ak.mdl"

SWEP.FakePos = Vector(-12, 2.53, 5.3)
SWEP.FakeAng = Angle(-1, 0.3, 5.5)
SWEP.AttachmentPos = Vector(3.8,2.1,-27.8)
SWEP.AttachmentAng = Angle(0,0,0)
SWEP.FakeAttachment = "1"
SWEP.FakeBodyGroups = "1c7031b6254"
SWEP.ZoomPos = Vector(0, 0.0033, 4.7792)
...
SWEP.MagModel = "models/weapons/arc9/darsu_eft/mods/mag_ak_izhmash_ak12_std_545x39_30.mdl"
...
SWEP.LocalMuzzlePos = Vector(21.8,-0.0,2.895)
SWEP.LocalMuzzleAng = Angle(-1.22,0.05,0)
...
SWEP.Spray = {}
for i = 1, 30 do
	SWEP.Spray[i] = Angle(-0.01 - math.cos(i) * 0.02, math.cos(i * i) * 0.02, 0) * 0.9
end

SWEP.WepSelectIcon2 = Material("vgui/inventory/weapon_ak12u")
SWEP.IconOverride = "vgui/inventory/weapon_ak12u"

SWEP.Ergonomics = 1
SWEP.WorldPos = Vector(5, -0.9, -1.1)
SWEP.WorldAng = Angle(0, 0, 0)
SWEP.UseCustomWorldModel = true
SWEP.attPos = Vector(-3.5, 27.8, 1.8)
SWEP.attAng = Angle(0, 0.4, -90)
SWEP.lengthSub = 25
...
SWEP.availableAttachments = {
	sight = {
		["mountType"] = {"picatinny"},
		["mount"] = {["picatinny"] = Vector(-18.64, 1.95, 0.15)},
		["mountAngle"] = {picatinny = Angle(0, 0, 0)},
	},
	barrel = {
		[1] = {"supressor1", Vector(0,0,0), {}},
		[2] = {"supressor8", Vector(0.4,-0.65,-0.2), {}},
		["mount"] = Vector(-0.15,0.47,0.15),
		["mountAngle"] = Angle(0, 1.5, 0),
	},
	grip = {
		["mount"] = { ["picatinny"] = Vector(4.85,0.4,0.05) },
	...
	underbarrel = {
		...
		["mount"] = {["ak12"] = Vector(0,0,0),["picatinny_small"] = Vector(4.3, 1, -0.1),["picatinny"] = Vector(6.8,0.95,0.05)},
		["mountAngle"] = {["ak12"] = Angle(0, 0, 0),["picatinny_small"] = Angle(0.55, -0.72, 0),["picatinny"] = Angle(-0.45, -0.33, 0)},
