...
SWEP.WorldModelFake = "models/weapons/c_inss2_toz_194m.mdl"


SWEP.FakePos = Vector(-2, 3, 7.5)
...
SWEP.WepSelectIcon2 = Material("vgui/hud/tfa_ins2_toz_194m")
SWEP.IconOverride = "vgui/hud/tfa_ins2_toz_194m"

SWEP.LocalMuzzlePos = Vector(25.2,0.65,5.25)
...
SWEP.availableAttachments = {
	barrel = {
		["mount"] = Vector(-1.15,0.35,0.0),
		[1] = {"supressor5", Vector(0,0,0), {}},
	},
	sight = {
		["mountType"] = "picatinny",
		["mount"] = Vector(-22.5, 1.2, 0.025),
	},
}
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(0, 0.6032, 6.2426)
...
SWEP.holsteredPos = Vector(4, 8.7, -9)
...
SWEP.AnimsEvents = {
	["base_reload_insert"] = {
		[0.1] = function(self, mdl)
			...
			mdl:ManipulateBoneScale(mdl:LookupBone("b_wpn_mag_b1"), Vector(1, 1, 1))
			--
	...
	["base_reload_end"] = {
		[0.0] = function(self, mdl)
			mdl:ManipulateBoneScale(mdl:LookupBone("b_wpn_mag_b1"), vector_origin)
		end,
	},
	["base_fire_cock_2"] = {
		[0.0] = function(self)
