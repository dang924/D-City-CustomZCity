...
SWEP.WorldModelFake = "models/weapons/tfa_ins2/c_p220.mdl"
SWEP.FakePos = Vector(-15.5, 2.50, 2.7)
...
SWEP.FakeEmptyReloadSounds = {
	[0.30] = "zcitysnd/sound/weapons/m9/handling/m9_magout.wav",
	[0.52] = "zcitysnd/sound/weapons/m9/handling/m9_magin.wav",
	[0.7] = "zcitysnd/sound/weapons/m9/handling/m9_maghit.wav",
	[0.81] = "zcitysnd/sound/weapons/m9/handling/m9_boltrelease.wav",
}
...
SWEP.lmagang2 = Angle(0,0,-30)

if CLIENT then
	local vector_full = Vector(1, 1, 1)
	SWEP.FakeReloadEvents = {
		[0.32] = function( self ) 
				hg.CreateMag( self, Vector(0,0,0) )
...
SWEP.WepSelectIcon2 = Material("vgui/hud/tfa_ins2_p220")
SWEP.IconOverride = "vgui/hud/tfa_ins2_p220"
...
SWEP.ZoomPos = Vector(0, 0.0989, 2.2973)
...
SWEP.availableAttachments = {
	barrel = {
		...
		[2] = {"supressor6", Vector(1.7,0.2,-0.5), {}},
		["mount"] = Vector(-0.075,0.4,0.07),
	},
}
...
function SWEP:DrawPost()
	...
	if CLIENT and IsValid(wep) then
		...
		wep:ManipulateBonePosition(40,Vector(0, -0.85*self.shooanim,-0.0 ),false)
	end
end
...
SWEP.LocalMuzzlePos = Vector(5.1,0.12,1.75)
