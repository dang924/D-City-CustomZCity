...
SWEP.FakeBodyGroups = "039000c0320"
...
function SWEP:ThinkAdd()
	if CLIENT and self:GetWM() and not isbool(self:GetWM()) and isstring(self.FakeBodyGroups) then
		if self:HasAttachment("grip", "grip_akdong") then
			self:GetWM():SetBodyGroups("029000c0320")
		else
...
SWEP.Spray = {}
for i = 1, 30 do
	SWEP.Spray[i] = Angle(-0.01 - math.cos(i) * 0.02, math.cos(i * i) * 0.02, 0) * 0.3
end

SWEP.WepSelectIcon2 = Material("vgui/hud/tfa_ins2_ak74m")
SWEP.IconOverride = "vgui/hud/tfa_ins2_ak74m"
