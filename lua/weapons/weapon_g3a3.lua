...
SWEP.WepSelectIcon2 = Material("vgui/inventory/weapon_g33")
SWEP.IconOverride = "vgui/inventory/weapon_g33"
SWEP.weight = 3.5
...
SWEP.ReloadTime = 5.1
SWEP.FakeBodyGroups = "00000120001"
SWEP.ReloadSoundes = {
	"none",
	"none",
...
SWEP.LocalMuzzlePos = Vector(18.004,1,9.4)
...
SWEP.Spray = {}
for i = 1, 20 do
	SWEP.Spray[i] = Angle(-0.02 - math.cos(i) * 0.03, math.cos(i * i) * 0.04, 0) * 1.2
end
...
SWEP.availableAttachments = {
	...
	grip = {
		["mount"] = Vector(0.5, 0.3, 0.0),
		["mountType"] = "picatinny"
	},
	underbarrel = {
	[1] = {"laser5", Vector(0.0,0.2,0.33), {}},

		["mount"] = {["picatinny_small"] = Vector(5, -0.4, -1.8),["picatinny"] = Vector(9,-1.2,0.8)},
		["mountAngle"] = {["picatinny_small"] = Angle(-0.95, 0.1, 180),["picatinny"] = Angle(0.4, 0.1, 90)},
