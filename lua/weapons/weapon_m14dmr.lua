...
SWEP.Instructions = "The M14 rifle, officially the United States Rifle, Caliber 7.62 mm, M14, is an American battle rifle chambered for the 7.62×51mm NATO cartridge. Designated marksman rifle (DMR) version of the M14 that was used by the United States Marine Corps."
SWEP.Category = "Weapons - Sniper Rifles"
SWEP.Slot = 2  ---Vector( 20.33, -2.78, -0.6 )
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_snip_g3sg1.mdl"
SWEP.WorldModelFake = "models/weapons/arccw/c_ud_m14.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ КАЛАШ
--PrintBones(Entity(1):GetActiveWeapon():GetWM())
--uncomment for funny
SWEP.FakePos = Vector(-8.5,2.8, 6.00)
SWEP.FakeAng = Angle(-0.0, -0.6, 0)
SWEP.FakeScale = 0.9
SWEP.AttachmentPos = Vector(3.8,2.1,-27.8)
SWEP.AttachmentAng = Angle(0,0,0)
SWEP.FakeAttachment = "1"
SWEP.FakeBodyGroups = "00000110000"
...
SWEP.availableAttachments = {
	...
	sight = {
		["mount"] = {picatinny = Vector(-18.7, 0.75, 0.00)},
		["mountType"] = {"picatinny"},
		["empty"] = {
			"empty",
		},
	...
	underbarrel = {
		["mount"] = {["picatinny"] = Vector(4.8,-0.35,-0.0)},
		["mountAngle"] = {["picatinny"] = Angle(-0.1, 0.1, 0)},
		["mountType"] = {"picatinny"},
	}
}
...
SWEP.ReloadTime = 5
SWEP.RestPosition = Vector(12, 1, 5)
SWEP.ReloadSoundes = {
	"none",
	"none",
...
SWEP.LocalMuzzlePos = Vector(27.285,0.42,4.2)
...
SWEP.Spray = {}
for i = 1, 20 do
	SWEP.Spray[i] = Angle(-0.01 - math.cos(i) * 0.02, math.cos(i * i) * 0.01, 0) * 0.5
end

SWEP.WepSelectIcon2 = Material("entities/m14ebr.png")
SWEP.WepSelectIcon2box = true
SWEP.IconOverride = "entities/m14ebr.png"
