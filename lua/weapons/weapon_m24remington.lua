...
SWEP.WorldModelFake = "models/weapons/m24/v_inss_m24.mdl"

SWEP.FakePos = Vector(-6.5, 3.4, 11.1)
...
SWEP.WepSelectIcon2 = Material("vgui/hud/tfa_inss_m24_new")
SWEP.IconOverride = "vgui/hud/tfa_inss_m24_new"

SWEP.LocalMuzzlePos = Vector(29, 0.25, 8.2)
...
SWEP.availableAttachments = {
	barrel = {
		[1] = {"supressor7", Vector(1.6,0,0), {}},
	},
	sight = {
		["mountType"] = "picatinny",
		["mount"] = Vector(-22.8, 1.1, 0),
	},
}
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(0, 0.2076, 9.6177)
...
SWEP.AnimsEvents = {
	["base_reload_start"] = {
		...
		[0.99] = function(self)
			self:GetWM():ManipulateBoneScale(66, vector_full)
		end,
	},
	["base_reload_insert"] = {
		[0.1] = function(self)
	...
	["base_reload_end"] = {
		[0.01] = function(self)
			self:GetWM():ManipulateBoneScale(66, vector_origin)
		end,
		[0.2] = function(self)
...
local function reloadFunc(self)
	...
	self:PlayAnim(self.AnimList["insert"] or "base_reload_Insert", 1, false, function() 
		...
		if !self.drawBullet then
			cock(self,1)
			self:PlayAnim(self.AnimList["finish_empty"] or "base_Fire_end", 1.5, false, function(self) self:SetNetVar("shootgunReload", 0) end, false, true) 
		else
			self:PlayAnim(self.AnimList["finish"] or "reload_end", 1.5, false, function(self) self:SetNetVar("shootgunReload", 0) end, false, true) 
		end
	end, false, true)
end
