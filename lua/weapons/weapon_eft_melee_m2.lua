...
SWEP.WorldModel = "models/weapons/arc9/darsu_eft/w_melee_bros_m2-2_lod0www.mdl"
SWEP.WorldModelReal = "models/weapons/arc9/darsu_eft/c_melee_bros_m2.mdl"
...
if CLIENT then
	SWEP.WepSelectIcon = Material("entities/arc9_eft_melee_m2.png")
	SWEP.IconOverride = "entities/arc9_eft_melee_m2.png"
...
SWEP.DamageSecondary = 36
SWEP.BleedMultiplier = 2.2
