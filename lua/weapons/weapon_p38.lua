...
SWEP.WorldModelFake = "models/weapons/arc9_doi/c_p38.mdl"
...
SWEP.WepSelectIcon2 = Material("entities/arc9_cb_ger_p38_walther.png")
SWEP.WepSelectIcon2box = true
SWEP.IconOverride = "entities/arc9_cb_ger_p38_walther.png"
...
SWEP.ZoomPos = Vector(0, 0.412, 2.0864)
...
SWEP.availableAttachments = {
	barrel = {
		...
		[2] = {"supressor6", Vector(1.0,-0.25,0), {}},
		["mount"] = Vector(-0.15,0.5,0.02),
	}
}
...
function SWEP:DrawPost()
	...
	if CLIENT and IsValid(wep) then
		...
		wep:ManipulateBonePosition(61,Vector(0, 0.53*self.shooanim,0 ),false)
	end
end
...
SWEP.LocalMuzzlePos = Vector(6.5,0.43,1.5)
