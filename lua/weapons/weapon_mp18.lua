...
SWEP.PrintName = "MP-18" -- сам ты дабл баррел
SWEP.Author = "Izhevsk Mechanical Plant"
SWEP.Instructions = "One-Shot Rifle Chambered in 7.62x54 mm"
...
SWEP.Primary.Sound = {"mosin/mosin_tp.wav", 80, 100, 75}
SWEP.Primary.Wait = 0
SWEP.OpenBolt = true
SWEP.WorldModelFake = "models/weapons/tfa_ins2/wpn_mp18_hud_v.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ КАЛАШ
...
SWEP.availableAttachments = {
	sight = {
		["mountType"] = {"picatinny"},
		["mount"] = {["picatinny"] = Vector(-25.0, 0.95, 0.5)},
		["mountAngle"] = {picatinny = Angle(1, -0.6, 0.00)},
	},
}
...
SWEP.FakeEmptyReloadSounds = {
	[0.27] = path.."open.ogg",
	[0.44] = "weapons/tfa_ins2/mosin/mosin_boltforward.wav",
	[0.65] = path.."struggle.ogg",
	[0.72] = "weapons/tfa_ins2/mosin/mosin_bulletin_2.wav",
	[0.94] =  path.."close.ogg",
}
...
SWEP.LocalMuzzlePos = Vector(31.1,1.15,0.7)
SWEP.LocalMuzzleAng = Angle(0.5,1,0)
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(0, 0.5471, 1.9809)
