...
SWEP.WorldModelFake = "models/weapons/tfa_ins2/c_minimi.mdl"
...
SWEP.WepSelectIcon2 = Material("vgui/hud/tfa_ins2_minimi")
SWEP.IconOverride = "vgui/hud/tfa_ins2_minimi"
...
SWEP.LocalMuzzlePos = Vector(19.832,0.880,6.060)
...
SWEP.ZoomPos = Vector(0, 0.8438, 8.2037)
...
SWEP.Spray = {}
for i = 1, 100 do
	SWEP.Spray[i] = Angle(-0.03 - math.cos(i) * 0.02, math.cos(i * i) * 0.04, 0) * 2.3
end
...
SWEP.availableAttachments = {
	...
	sight = {
		["mount"] = Vector(-20, 2, -0.15),
		["mountType"] = "picatinny",
	},
	underbarrel = {
	[1] = {"laser5", Vector(0.0,0.2,0.33), {}},

		["mount"] = {["picatinny_small"] = Vector(1.5, -1.47, -2.2),["picatinny"] = Vector(5.5,-2.3,0.8)},
