...
SWEP.LocalMuzzlePos = Vector(25,0.4,4.25)
SWEP.LocalMuzzleAng = Angle(0.8,-0.0,0)
...
SWEP.Primary.Cone = 0
SWEP.Primary.Spread = Vector(0.015, 0.015, 0.015)
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(0, 0.3659, 5.3659)
