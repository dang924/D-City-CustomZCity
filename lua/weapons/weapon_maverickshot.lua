...
SWEP.WorldModelFake = "models/weapons/tfa_ins2/c_m590_olli.mdl"
SWEP.FakeScale = 0.95

SWEP.FakePos = Vector(-2.5, 2.5, 7.2)
...
SWEP.WepSelectIcon2 = Material("vgui/hud/tfa_ins2_m590o")
SWEP.IconOverride = "vgui/hud/tfa_ins2_m590o"

SWEP.LocalMuzzlePos = Vector(29,0.65,5.15)
SWEP.LocalMuzzleAng = Angle(-0.55,-0.02,0)
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(0, 0.6328, 6.0514)
...
function SWEP:DrawPost()
	...
	if not IsValid(self.BMerge) then
		self:SetupBoneMerge("models/weapons/tfa_ins2/upgrades/a_standard_m590_olli.mdl")
	else
		self.BMerge:SetupBones()
		self.BMerge:DrawModel()
	end
