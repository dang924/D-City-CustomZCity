...
SWEP.Instructions = "The AK-104 is a carbine variant of the AK-103 chambered in 7.62x39mm which feeds from any standard 7.62x39 AK pattern magazine."
...
SWEP.FakeBodyGroups = "03b100c2220"
...
SWEP.availableAttachments = {
	barrel = {
		...
		[2] = {"supressor6", Vector(0,0.65,0), {}},
		["mount"] = Vector(0.1,0.2,0),
		["mountAngle"] = Angle(0,0,0)
	},
	sight = {
		["mountType"] = {"picatinny", "dovetail"},
		["mount"] = {["dovetail"] = Vector(-18.4, 2.2, -0.45),["picatinny"] = Vector(-17.9, 2.65, -0.22)},
	},
	mount = {
		["picatinny"] = {
			"mount3",
...
SWEP.LocalMuzzlePos = Vector(18.986,-0.2,2.741)
...
SWEP.Spray = {}
for i = 1, 30 do
	SWEP.Spray[i] = Angle(-0.02 - math.cos(i) * 0.03, math.cos(i * i) * 0.02, 0) * 3.1
end
