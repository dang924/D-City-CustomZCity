...
SWEP.PrintName = "FN FAL Para"
SWEP.Author = "FN Herstal"
SWEP.Instructions = "The FAL (French: Fusil Automatique Léger 'Light Automatic Rifle') is a battle rifle designed in Belgium by Dieudonné Saive chambered in 7.62x51 mm with a fire rate of 700 RPM. This version of the rifle has a shortened barrel,picatinny rail aswell as a bipod"
SWEP.Category = "Weapons - Assault Rifles"
SWEP.Slot = 2  ---Vector( 20.33, -2.78, -0.6 )
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_snip_g3sg1.mdl"
SWEP.WorldModelFake = "models/weapons/nmrih/falpara/v_fa_falpara.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ КАЛАШ
...
SWEP.ZoomPos = Vector(0, 0.768, 5.0692)

SWEP.GunCamPos = Vector(4,-15,-6)
SWEP.GunCamAng = Angle(190,-5,-100)
SWEP.FakeEjectBrassATT = "ejection_port"
//SWEP.MagIndex = 57
//MagazineSwap
...
SWEP.EjectPos = Vector(2.3,17.3,-2.5)
SWEP.EjectAng = Angle(-30,-90,0)



SWEP.FakeMagDropBone = 56
	...
	SWEP.FakeReloadEvents = {
		[0.39] = function( self, timeMul )
			if self:Clip1() < 1 then
				...
				self:GetWM():ManipulateBoneScale(63, vecPochtiZero)
			end 
		end,
...
SWEP.availableAttachments = {
	...
	sight = {
		["mount"] = {picatinny = Vector(-26.3, 1.5, 0.0)},
		["mountType"] = {"picatinny"},
		["empty"] = {
			"empty",
		},
...
SWEP.LocalMuzzlePos = Vector(26.285,0.75,3.15)
...
SWEP.Spray = {}
for i = 1, 20 do
	SWEP.Spray[i] = Angle(-0.03 - math.cos(i) * 0.02, math.cos(i * i) * 0.04, 0) * 1
end
...
SWEP.bipodsub = 15
SWEP.RestPosition = Vector(14, 2, 3)
...
function SWEP:DrawPost()
	...
	if CLIENT and IsValid(wep) then
		...
		wep:ManipulateBonePosition(59,Vector(-1.2*self.shooanim ,0 ,0 ),false)
	end	
end
