...
SWEP.WorldModelFake = "models/weapons/tfa_ins2/zm_lr300/c_zm_lr300.mdl" -- Контент инсурги https://steamcommunity.com/sharedfiles/filedetails/?id=3437590840 models/weapons/zcity/v_416c.mdl
--uncomment for funny
	...
	SWEP.FakeReloadEvents = {
		...
		[0.3] = function( self, timeMul )
			if self:Clip1() < 1 then
				...
				self:GetWM():ManipulateBoneScale(107, vecPochtiZero)
				self:GetWM():ManipulateBoneScale(108, vecPochtiZero)
			else
		...
		[0.4] = function( self, timeMul )
			if self:Clip1() < 1 then
				...
				self:GetWM():ManipulateBoneScale(107, vector_full)
				self:GetWM():ManipulateBoneScale(108, vector_full)
			else
				//self:GetWM():ManipulateBoneScale(75, vector_full)
				//self:GetWM():ManipulateBoneScale(76, vector_full)
				//self:GetWM():ManipulateBoneScale(77, vector_full)
...
SWEP.WepSelectIcon2 = Material("vgui/hud/tfa_ins2_zm_lr300")
SWEP.IconOverride = "vgui/hud/tfa_ins2_zm_lr300"
...
SWEP.Primary.Wait = 0.053

SWEP.availableAttachments = {
	barrel = {
		[1] = {"supressor2", Vector(0,0,0), {}},
		[2] = {"supressor6", Vector(2.2,0,-0.2), {}},
		["mount"] = Vector(-6,0.25,0.24),
	},
	sight = {
		["mount"] = { ironsight = Vector(-19.55, 1.1, 0.1), picatinny = Vector(-19, 1.05, 0.1)},
	...
	underbarrel = {
		...
		["mount"] = {["picatinny_small"] = Vector(5.5, -0.5, -1.95),["picatinny"] = Vector(8,-1.3,1.2)},
		["mountAngle"] = {["picatinny_small"] = Angle(-1, 0.1, 180),["picatinny"] = Angle(0.3, -0.0, 90)},
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(0, -0.0791, 5.1912)
...
SWEP.LocalMuzzlePos = Vector(23.5,0,3.25)
SWEP.LocalMuzzleAng = Angle(0,0,0)
SWEP.WeaponEyeAngles = Angle(0,0,0.002)

SWEP.attPos = Vector(-0, -22.0, -3)
...
function SWEP:DrawPost()
	...
	if CLIENT and IsValid(wep) then
		...
		vec[3] = 0
		wep:ManipulateBonePosition(104,vec,false)
