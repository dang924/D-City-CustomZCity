...
SWEP.PrintName = "MPi-KM74"
SWEP.Author = "VEB Geräte- und Werkzeugbau Wiesa"
SWEP.Instructions = "The MPi-KM74 is a East German license-manufactured version of the Soviet AK-74 assault rifle chambered in 5.45x39."
SWEP.Category = "Weapons - Assault Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_rif_ak47.mdl"
SWEP.WorldModelFake = "models/weapons/c_dmi_mpi-km74-km.mdl" -- Контент инсурги https://steamcommunity.com/sharedfiles/filedetails/?id=3437590840 
--uncomment for funny
...
SWEP.WepSelectIcon2 = Material("vgui/entities/hud/weapon_tfa_mpi-km74")
SWEP.IconOverride = "vgui/entities/hud/weapon_tfa_mpi-km74"
SWEP.ScrappersSlot = "Primary"
SWEP.availableAttachments = {
	sight = {
		["mountType"] = {"dovetail","picatinny"},
		["mount"] = {["dovetail"] = Vector(-27, 2.2, -0.4),["picatinny"] = Vector(-28, 2.9, -0.15)},
	},
	mount = {
		["picatinny"] = {
			"mount3",
	...
	barrel = {
		[1] = {"supressor1", Vector(0,0.0,0.0), {}},
		[2] = {"supressor6", Vector(-1.5,0.35,-0.2), {}},
		["mount"] = Vector(-2.9,0.7,0.07),
	},
}

SWEP.LocalMuzzlePos = Vector(27,0.1,2.7)
SWEP.LocalMuzzleAng = Angle(0.4,-0.06,0)
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(0, 0.1417, 5.0132)
...
function SWEP:DrawPost()
	...
	if CLIENT and IsValid(wep) then
		...
		vec[1] = 0
		vec[2] = 1.8*self.shooanim
		vec[3] = 0
		wep:ManipulateBonePosition(58,vec,false)
	end
end
