...
SWEP.PrintName = "HK MP5/10"
SWEP.Author = "Heckler & Koch"
SWEP.Instructions = "Submachine gun chambered in 10mm Auto\n\nRate of fire 800 rounds per minute"
...
SWEP.AnimList = {
	["idle"] = "idle",
	["reload"] = "reload_10mm",
	["reload_empty"] = "reload_empty_10mm",
}
if CLIENT then
...
SWEP.LocalMuzzlePos = Vector(12.706,-0.488,3.525)
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(0, -0.4977, 5.6856)
...
SWEP.availableAttachments = {
	barrel = {
		...
		[2] = {"supressor6", Vector(0,0.5,0), {}},
		["mount"] = Vector(-0.5,-0.05,0),
	},
		sight = {
		["mount"] = { picatinny = Vector(-13.15, 2, 0.1)},
		["mountAngle"] = { picatinny = Angle(0, 0, 0.00)},
		["mountType"] = {"picatinny"},
	},
	underbarrel = {
			[1] = {"laser5", Vector(0.0,0.2,0.15), {}},

		["mount"] = {["picatinny_small"] = Vector(9.3, -0.17, 0.05)},
		["mountAngle"] = {["picatinny_small"] = Angle(0.9, -0.1, 0)},
		["mountType"] = {"picatinny_small"},
	},
	grip = {
		["mount"] = Vector(7.5 + 9.3 - 6, -0.55 + 1, 0.05),
		["mountType"] = "picatinny"
	},
}
...
SWEP.Spray = {}
for i = 1, 30 do
	SWEP.Spray[i] = Angle(-0.0, 0, 0) * 1.15
end
