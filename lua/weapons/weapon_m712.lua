...
SWEP.Author = "Mauser"
SWEP.Instructions = "Automatic Pistol chambered in 9x19 mm Parabellum\n\nRate of fire 1000 rounds per minute"
SWEP.Category = "Weapons - Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_pist_fiveseven.mdl"
SWEP.WorldModelFake = "models/weapons/arc9_doi/c_c96_carbine.mdl"
SWEP.FakePos = Vector(-13, 2.90, 3.5)
...
SWEP.CantFireFromCollision = false
...
SWEP.FakeReloadSounds = {
	[0.30] = "weapons/m1911/m1911_magrelease.wav",
	[0.35] = "weapons/m1911/m1911_magout.wav",
	[0.65] = "weapons/m1911/m1911_magin.wav",
	[0.75] = "weapons/m1911/m1911_maghit.wav",
}

SWEP.FakeEmptyReloadSounds = {
	[0.27] = "weapons/m1911/m1911_magrelease.wav",
	[0.30] = "weapons/m1911/m1911_magout.wav",
	[0.55] = "weapons/m1911/m1911_magin.wav",
	[0.60] = "weapons/m1911/m1911_maghit.wav",
	[0.80] = "weapons/m1911/m1911_boltrelease.wav",
}
...
SWEP.WepSelectIcon2 = Material("vgui/inventory/weapon_c96carbine")
SWEP.IconOverride = "vgui/inventory/weapon_c96carbine"
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(0, -0.1252, 1.8985)
...
SWEP.attPos = Vector(11, 1.2, 6.5)
SWEP.attAng = Angle(0, -0.2, 0)
SWEP.lengthSub = 25
SWEP.DistSound = "m9/m9_dist.wav"
SWEP.holsteredBone = "ValveBiped.Bip01_Spine2"
SWEP.holsteredPos = Vector(5, 7, 2)
SWEP.holsteredAng = Angle(210, 0, 180)
SWEP.availableAttachments = {
	barrel = {
		[1] = {"supressor4", Vector(0,0,0), {}},
		[2] = {"supressor6", Vector(-5,0.15,0), {}},
		["mount"] = Vector(-0.5,0.4,0.05),
	}
}
...
function SWEP:DrawPost()
	...
	if CLIENT and IsValid(wep) then
		...
		wep:ManipulateBonePosition(92,Vector(0, 0.95*self.shooanim,0 ),false)
	end
end
...
SWEP.LocalMuzzlePos = Vector(20.5,-0.1,1.1)
SWEP.LocalMuzzleAng = Angle(0.1,-0.01,0)
