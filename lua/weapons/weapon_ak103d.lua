...
SWEP.Instructions = "The AK-103 is an assault rifle designed by Russian small arms designer Mikhail Kalashnikov. Chambered in 7.62x39 belonging to the export AK-100."
...
SWEP.FakeBodyGroups = "03b100c0320"
...
SWEP.WepSelectIcon2 = Material("vgui/hud/tfa_ins2_ak103")
SWEP.IconOverride = "vgui/hud/tfa_ins2_ak103"
SWEP.ScrappersSlot = "Primary"
SWEP.availableAttachments = {
	barrel = {
		[1] = {"supressor1", Vector(0,0,0), {}},
		[2] = {"supressor6", Vector(0,0,0), {}},
		["mount"] = Vector(-1,0.2,0),
...
SWEP.Spray = {}
for i = 1, 30 do
	SWEP.Spray[i] = Angle(-0.02 - math.cos(i) * 0.03, math.cos(i * i) * 0.02, 0) * 2.2
end
