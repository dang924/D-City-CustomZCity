...
SWEP.Instructions = "CSGC is China's most notable small arms manufacturer, with its subsidiaries designing and manufacturing most of the small arms in service in the People's Liberation Army."
SWEP.Category = "Weapons - Machine-Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_rif_ak47.mdl"
SWEP.WorldModelFake = "models/weapons/arccw/eap/c_csls5.mdl"

SWEP.FakePos = Vector(-15, 4.5, 4.5)
...
SWEP.Primary.Sound = {"weapons/arccw/eap/csls5/fire.wav", 85, 90, 100}
SWEP.Primary.SoundFP = {"weapons/arccw/eap/csls5/fire.wav", 85, 90, 100}
...
SWEP.WepSelectIcon2 = Material("entities/arccw_eap_csls5.png")
SWEP.WepSelectIcon2box = true
SWEP.IconOverride = "entities/arccw_eap_csls5.png"
...
SWEP.availableAttachments = {
    sight = {
        ["mountType"] = {"picatinny"},
        ["mount"] = { ["picatinny"] = Vector(-15, 0.1, 0.7) },
        ["mountAngle"] = { ["picatinny"] = Angle(0, 0, 90) },
        
        
        [1] = {"optic2", Vector(1.5, -1.3, 1.5), {}}, -- Burris Fullfield TAC30
        [2] = {"optic5", Vector(1.5, -1.3, 1.5), {}}, -- Vortex Razor HD Gen 2
        [3] = {"optic6", Vector(-1, -1.3, 1.5), {}},   -- Leupold Mark 4
    },
    barrel = {
