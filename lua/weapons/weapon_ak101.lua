...
SWEP.Instructions = "The AK-101 is a Kalashnikov assault rifle model developed in 1994 to use the 5.56x45mm NATO cartridge belonging to the export AK-100\n\nRate of fire 600 rounds per minute"
...
SWEP.FakeBodyGroups = "03a000c0322"
//SWEP.MagIndex = 53
//MagazineSwap
...
SWEP.WepSelectIcon2 = Material("vgui/entities/hud/weapon_tfa_dmak101")
SWEP.IconOverride = "vgui/entities/hud/weapon_tfa_dmak101"
...
SWEP.LocalMuzzlePos = Vector(27.085,-0.0,2.995)
...
function SWEP:ThinkAdd()
	if CLIENT and self:GetWM() and not isbool(self:GetWM()) and isstring(self.FakeBodyGroups) then
		if self:HasAttachment("grip", "grip_akdong") then
			self:GetWM():SetBodyGroups("02a000c0322")
		else
