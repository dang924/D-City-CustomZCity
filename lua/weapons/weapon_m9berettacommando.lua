...
SWEP.PrintName = [[Beretta M9 "Commando"]]
SWEP.Author = "Unknown..."
SWEP.Instructions = "The Beretta M9, officially the Pistol, Semiautomatic, 9mm, M9, is the designation for the Beretta 92FS semi-automatic pistol used by Armed Forces. Chambered in 9x19 mm. Seems like this gun has seen battle many times."
SWEP.Category = "Weapons - Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_pist_elite_single.mdl"
SWEP.WorldModelFake = "models/weapons/c_beretta_commando.mdl"

SWEP.FakePos = Vector(-12, 2.5, 4.9)
SWEP.FakeAng = Angle(0, 0, 0)
SWEP.AttachmentPos = Vector(0,-0.1,0)
SWEP.AttachmentAng = Angle(0,90,0)
SWEP.ZoomPos = Vector(0, 0.2966, 4.4265)
...
SWEP.WepSelectIcon2 = Material("vgui/hud/tfa_ins2_m9_commando")
SWEP.IconOverride = "vgui/hud/tfa_ins2_m9_commando"
...
if CLIENT then
	...
	SWEP.FakeReloadEvents = {
		...
		[0.15] = function( self, timeMul )
			if self:Clip1() < 1 then
			self:GetOwner():PullLHTowards("ValveBiped.Bip01_L_Thigh", 1.2 * timeMul)
			end
		end,
		[0.57] = function( self )
			if self:Clip1() < 1 then
...
SWEP.LocalMuzzlePos = Vector(10.5,0.33,3.85)
...
SWEP.availableAttachments = {
	barrel = {
		...
		[2] = {"supressor6", Vector(1,0.2,-0.5), {}},
		--[3] = {"supressor3", Vector(0,0.2,0), {}},
		["mount"] = Vector(-0.35,0.4,0.03),
	},
}
...
function SWEP:DrawPost()
	...
	if CLIENT and IsValid(wep) then
		...
		wep:ManipulateBonePosition(66,Vector(0 ,1*self.shooanim ,0 ),false)
	end
end
