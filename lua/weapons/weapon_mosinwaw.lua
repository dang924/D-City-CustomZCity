...
SWEP.WorldModelFake = "models/weapons/v_waw_mosin_irons.mdl"

SWEP.FakePos = Vector(-3, 1.8, 8.5)
...
SWEP.FakeReloadSounds = {
	[0.05] = "weapons/waw_mosin/pull.wav",
	[0.5] = "weapons/waw_mosin/in.wav",
	[0.7] = "weapons/waw_mosin/release.wav",
}

SWEP.FakeEmptyReloadSounds = {
	[0.2] = "weapons/waw_mosin/pull.wav",
	[0.5] = "weapons/waw_mosin/in.wav",
	[0.7] = "weapons/waw_mosin/release.wav",
}
...
SWEP.AnimsEvents = {
	["fire"] = {
		[0.1] = function(self)
			self:EmitSound("weapons/waw_mosin/pull.wav", 45, math_random(110, 115))
		end,
		[0.55] = function(self)
		...
		[0.7] = function(self)
			self:EmitSound("weapons/waw_mosin/release.wav", 45, math_random(110, 115))
		end,
		[0.5] = function(self)
			self:EmitSound("", 45, math_random(110, 115))
		end
	}
}
...
SWEP.Primary.Sound = {"weapons/waw_mosin/fire.wav", 65, 90, 100}
...
function SWEP:Reload(time)
	...
	if self.drawBullet == false and SERVER then
		...
		self:PlayAnim(self.AnimList["cycle"] or "fire", 1.5, false, nil, false, true)
		return
	end
	...
	if SERVER then
		...
		self:PlayAnim(self.AnimList["reload"] or "reload_tac", self.StaminaReloadTime, false, nil, false, true)
