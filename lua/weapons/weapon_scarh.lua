...
SWEP.FakePos = Vector(-15.0, 4.50, 12.27)
...
SWEP.ReloadTime = 5.1
SWEP.FakeBodyGroups = "0000060000"
SWEP.ReloadSoundes = {
	"none",
	"none",
...
SWEP.LocalMuzzlePos = Vector(12.004,0.55,7.9)
...
SWEP.FakeEmptyReloadSounds = {
	...
	[0.75] = "weapons/m4a1/m4a1_magain.wav",
	[0.93] = "weapons/arccw_ur/g3/chslap.ogg",
}
...
SWEP.Spray = {}
for i = 1, 20 do
	SWEP.Spray[i] = Angle(-0.02 - math.cos(i) * 0.03, math.cos(i * i) * 0.03, 0) * 1.0
end
...
if CLIENT then
	SWEP.FakeReloadEvents = {
		...
		[0.30] = function( self, timeMul )
			if self:Clip1() < 1 then
				local ent = hg.CreateMag( self, Vector(0,-50,20),nil, true )
