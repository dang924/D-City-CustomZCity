...
SWEP.WorldModelFake = "models/weapons/arc9_doi/c_ppk.mdl"
SWEP.FakePos = Vector(-14, 2.90, 2.7)
...
SWEP.WepSelectIcon2 = Material("entities/arc9_cb_ger_ppk_walther_ehrenwaffen.png")
SWEP.WepSelectIcon2box = true
SWEP.IconOverride = "entities/arc9_cb_ger_ppk_walther_ehrenwaffen.png"
...
SWEP.ZoomPos = Vector(0, 0.4087, 1.9183)
...
SWEP.availableAttachments = {
	barrel = {
		...
		[2] = {"supressor6", Vector(2.5,-0.0,0), {}},
		["mount"] = Vector(-0.3,0.32,0.02),
	}
}
...
function SWEP:DrawPost()
	...
	if CLIENT and IsValid(wep) then
		...
		wep:ManipulateBonePosition(65,Vector(0, 0.53*self.shooanim,0 ),false)
	end
end
...
SWEP.LocalMuzzlePos = Vector(4.0,0.43,1.21)
