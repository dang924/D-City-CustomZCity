...
/*function ENT:OnThinkActive()
	if IsValid(self:GetEnemy()) && self:GetEnemy():Classify() == CLASS_COMBINE_GUNSHIP then -- to do
		"vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_gunship01.wav",
		"vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_gunship02.wav",
		"vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_gunship03.wav",
		"vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_gunship04.wav",
		"vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_gunship05.wav",
		"vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_gunship06.wav",
		"vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_gunship07.wav",
		"vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_gunship08.wav",
	end
end*/
---------------------------------------------------------------------------------------------------------------------------------------------
			...
			if wep:GetPrimaryAmmoType() > -1 then
				...
				if !self.IsMedic && ent:GetAmmoCount(ammoType) <= 255 && IsValid(self:GetActiveWeapon()) && !self:IsBusy() then
					if entDist > 100 then
						...
						self:PlaySoundSystem("Speech", (self.Human_Gender == HUMAN_GENDER_FEMALE and sdGiveAmmo_F) or sdGiveAmmo_M)
					end
				-- Reload Freeman!
				elseif wep:Clip1() < wep:GetMaxClip1() && ent:GetAmmoCount(ammoType) > 0 then
					self:PlaySoundSystem("Speech", (self.Human_Gender == HUMAN_GENDER_FEMALE and sdSuggestReloadPly_F) or sdSuggestReloadPly_M)
				end
			end
		end
	end
...
function ENT:OnAlert(ent)
	if math.random(1, 2) == 1 && ent:IsNPC() then
		...
		elseif ent:GetClass() == "npc_rollermine" then
			self:PlaySoundSystem("Alert", {"vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_rollers01.wav", "vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_rollers02.wav", "vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_rollers03.wav"})
			return
		...
		elseif ent:GetClass() == "npc_strider" or ent:GetClass() == "npc_vj_hlr2_com_strider" then
			...
			if self.Human_Gender == HUMAN_GENDER_MALE then table.insert(tbl2, "vj_hlr/src/npc/citizen_beta/strider.wav") table.insert(tbl2, "vj_hlr/src/npc/citizen_beta/strider02.wav") end
			self:PlaySoundSystem("Alert", tbl2)
			return
		elseif self.Human_Gender == HUMAN_GENDER_MALE && (ent:Classify() == CLASS_MACHINE or ent.VJ_ID_Turret or ent:GetClass() == "npc_turret_floor") then
			self:PlaySoundSystem("Alert", {"vj_hlr/src/npc/citizen_beta/turret.wav", "vj_hlr/src/npc/citizen_beta/turrets.wav"})
			return
		...
		elseif ent:Classify() == CLASS_COMBINE_GUNSHIP then
			...
			for _, v in ipairs(ent.VJ_NPC_Class or {1}) do
				...
				elseif v == "CLASS_ZOMBIE" or ent:Classify() == CLASS_ZOMBIE then
					self:PlaySoundSystem("Alert", {"vo/npc/" .. self.Human_SdFolder .. "/zombies01.wav", "vo/npc/" .. self.Human_SdFolder .. "/zombies02.wav", "vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_zombie01.wav", "vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_zombie02.wav", "vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_zombie07.wav", "vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_zombie08.wav"})
					return
				elseif v == "CLASS_ANTLION" or ent:Classify() == CLASS_ANTLION then
					local tbl2 = {"vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_antlions03.wav", "vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_antlions05.wav", "vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_antlions07.wav", "vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_antlions12.wav", "vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_antlions13.wav", "vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_antlions15.wav", "vj_hlr/src/npc/ep1/npc/" .. self.Human_SdFolder .. "/cit_alert_antlions18.wav"}
					if self.Human_Gender == HUMAN_GENDER_MALE then table.insert(tbl2, "vj_hlr/src/npc/ep2/outland_02/griggs_wegotantlions02.wav") end
					self:PlaySoundSystem("Alert", tbl2)
					return
				end
			end
...
function ENT:HLR_ApplyMaleSounds()
	...
	self.SoundTbl_IdleDialogue = {
		...
		"vj_hlr/src/npc/ep1/npc/male01/cit_alert_antlions14.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks01.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks02.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks03.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks04.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks05.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks06.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks07.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks08.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks09.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks10.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks11.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks12.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks13.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks14.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks15.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks16.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks17.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks18.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks19.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks20.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks21.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_remarks22.wav",
	...
	self.SoundTbl_CombatIdle = {
		...
		"vj_hlr/src/npc/ep1/npc/male01/cit_alert_zombie04.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_behindyousfx01.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_behindyousfx02.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_squad_flee02.wav",
		"vj_hlr/src/npc/ep2/male02/reb2_antlions05.wav",
		"vj_hlr/src/npc/ep2/male02/reb2_antlions12.wav",
		"vj_hlr/src/npc/ep2/male02/reb2_buddykilled13.wav",
		"vj_hlr/src/npc/ep2/outland_02/griggs_betweenwave_03.wav",
		"vj_hlr/src/npc/ep2/outland_12/reb1_lastwave10.wav",
		"vj_hlr/src/npc/ep2/outland_12/reb1_lastwaveannounced03.wav",
		"vj_hlr/src/npc/ep2/outland_12/reb1_lastwaveannounced05.wav",
		"vj_hlr/src/npc/ep2/outland_12/reb1_lastwaveannounced06.wav",
	...
	self.SoundTbl_Alert = {
		...
		"vj_hlr/src/npc/ep1/npc/male01/cit_alert_antlions08.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_alert_head06.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_evac_enemies01.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_theyfoundus.wav",
	...
	self.SoundTbl_CallForHelp = {
		...
		"vj_hlr/src/npc/ep1/npc/male01/cit_alert_antlions06.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_alert_rollers04.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_comehere.wav",
	...
	self.SoundTbl_Suppressing = {
		...
		"vj_hlr/src/npc/ep1/npc/male01/cit_alert_zombie09.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_evac_enemies02.wav",
		"vj_hlr/src/npc/ep2/outland_02/griggs_fightlion_01.wav",
		"vj_hlr/src/npc/ep2/outland_02/griggs_fightlion_05.wav",
		"vj_hlr/src/npc/ep2/outland_08/chopper/rebc_chop_hit01.wav",
		"vj_hlr/src/npc/ep2/outland_08/chopper/rebc_chop_hit02.wav",
		"vj_hlr/src/npc/ep2/outland_08/chopper/rebc_chop_hit04.wav",
		"vj_hlr/src/npc/ep2/outland_08/chopper/reb1_chop_chopper_hint01.wav",
		"vj_hlr/src/npc/ep2/outland_12/reb1_sawmillexplo05.wav",
		"vj_hlr/src/npc/ep2/outland_12/reb1_sawmillexplo06.wav",
		"vj_hlr/src/npc/ep2/outland_12/reb1_striderdown11.wav",
	...
	self.SoundTbl_GrenadeSight = {
		...
		"vj_hlr/src/npc/ep1/npc/male01/cit_alert_head06.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_evac_defendus06.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_runforit.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_shock01.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_shock02.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_shock03.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_shock04.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_shock05.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_shock06.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_shock07.wav",
	...
	self.SoundTbl_KilledEnemy = {
		...
		"vj_hlr/src/npc/ep1/npc/male01/cit_evac_casualty06.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_evac_thanks03.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_evac_thanks04.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_evac_thanks05.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_kill01.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_kill02.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_kill03.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_kill04.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_kill05.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_kill06.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_kill07.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_kill08.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_kill09.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_kill10.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_kill11.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_kill12.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_kill13.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_kill14.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_kill15.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_kill16.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_kill17.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_kill19.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_kill20.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_thesearesomuchfun.wav",
		"vj_hlr/src/npc/ep2/male02/reb2_killshots01.wav",
		"vj_hlr/src/npc/ep2/male02/reb2_killshots22.wav",
		"vj_hlr/src/npc/ep2/outland_02/griggs_killlion_02.wav",
		"vj_hlr/src/npc/ep2/outland_02/griggs_killlion_03.wav",
		"vj_hlr/src/npc/ep2/outland_08/chopper/reb1_chop_goodgoing.wav",
		"vj_hlr/src/npc/ep2/outland_11/dogfight/reb1_str_dogcheers01.wav",
		"vj_hlr/src/npc/ep2/outland_11/dogfight/reb1_str_dogcheers02.wav",
		"vj_hlr/src/npc/ep2/outland_11/dogfight/reb1_str_dogcheers04.wav",
		"vj_hlr/src/npc/ep2/outland_12/reb1_striderdown05.wav",
		"vj_hlr/src/npc/ep2/outland_12/reb1_striderdown06.wav",
	...
	self.SoundTbl_AllyDeath = {
		...
		"vj_hlr/src/npc/ep1/npc/male01/cit_buddykilled01.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_buddykilled02.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_buddykilled03.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_buddykilled04.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_buddykilled05.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_buddykilled06.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_buddykilled07.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_buddykilled08.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_buddykilled09.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_buddykilled10.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_buddykilled11.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_buddykilled12.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_buddykilled13.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_evac_casualty01.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_evac_casualty02.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_evac_casualty03.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_evac_casualty05.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_evac_casualty09.wav",
	...
	self.SoundTbl_Pain = {
		...
		"vj_hlr/src/npc/ep1/npc/male01/cit_pain01.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_pain02.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_pain03.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_pain04.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_pain05.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_pain06.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_pain07.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_pain08.wav",
		"vj_hlr/src/npc/ep1/npc/male01/cit_pain09.wav",
	...
	"vj_hlr/src/npc/ep1/npc/male01/cit_notice_gravgunkill02.wav",
	"vj_hlr/src/npc/ep1/npc/male01/cit_notice_gravgunkill03.wav",
	"vj_hlr/src/npc/ep1/npc/male01/cit_notice_gravgunkill04.wav",
	"vj_hlr/src/npc/ep2/outland_12/reb1_striderdown01.wav",
	"vj_hlr/src/npc/ep2/outland_12/reb1_striderdown04.wav",
	"vj_hlr/src/npc/ep2/outland_12/reb1_striderdown09.wav",
	"vj_hlr/src/npc/ep2/outland_12/reb1_striderdown13.wav",
	"vj_hlr/src/npc/citizen_beta/wowniceshot01.wav",
	"vj_hlr/src/npc/citizen_beta/wowniceshot02.wav",
	]]--
end
...
function ENT:HLR_ApplyFemaleSounds()
	...
	self.SoundTbl_IdleDialogue = {
		...
		"vj_hlr/src/npc/ep1/npc/female01/cit_alert_antlions14.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_remarks01.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_remarks02.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_remarks03.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_remarks04.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_remarks05.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_remarks06.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_remarks07.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_remarks08.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_remarks09.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_remarks10.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_remarks11.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_remarks12.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_remarks13.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_remarks14.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_remarks15.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_remarks16.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_remarks17.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_remarks18.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_remarks19.wav",
	...
	self.SoundTbl_CallForHelp = {
		...
		"vj_hlr/src/npc/ep1/npc/female01/cit_alert_antlions06.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_comehere.wav",
	...
	self.SoundTbl_GrenadeSight = {
		...
		"vj_hlr/src/npc/ep1/npc/female01/cit_alert_head06.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_evac_defendus06.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_runforit.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_shock01.wav",
	...
	self.SoundTbl_KilledEnemy = {
		...
		"vj_hlr/src/npc/ep1/npc/female01/cit_evac_casualty06.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_evac_thanks03.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_evac_thanks04.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_evac_thanks05.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_kill01.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_kill02.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_kill03.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_kill04.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_kill05.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_kill06.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_kill07.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_kill08.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_kill09.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_kill10.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_kill11.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_kill12.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_kill13.wav",
	...
	self.SoundTbl_AllyDeath = {
		...
		"vj_hlr/src/npc/ep1/npc/female01/cit_buddykilled01.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_buddykilled02.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_buddykilled03.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_buddykilled04.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_buddykilled05.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_buddykilled06.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_buddykilled07.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_buddykilled08.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_buddykilled09.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_buddykilled10.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_buddykilled11.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_buddykilled12.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_buddykilled13.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_buddykilled14.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_buddykilled15.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_evac_casualty01.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_evac_casualty02.wav",
	...
	self.SoundTbl_Pain = {
		...
		"vj_hlr/src/npc/ep1/npc/female01/cit_pain01.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_pain02.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_pain03.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_pain04.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_pain05.wav",
		"vj_hlr/src/npc/ep1/npc/female01/cit_pain06.wav",
	...
	"vj_hlr/src/npc/ep1/npc/female01/cit_notice_gravgunkill02.wav",
	"vj_hlr/src/npc/ep1/npc/female01/cit_notice_gravgunkill03.wav",
	"vj_hlr/src/npc/ep1/npc/female01/cit_notice_gravgunkill04.wav",
	]]--
end