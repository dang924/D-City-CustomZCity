...
function ENT:Zombie_OnInit()
    ...
    elseif self:GetModel() == "models/darkborn/l4d2/common/common_male_polo_jeans.mdl" then
        self:SetBodygroup(0,math.random(0,1))
        self:SetBodygroup(1,math.random(0,3))
        self:SetSkin(math.random(0,3))

    elseif self:GetModel() == "models/darkborn/l4d2/common/common_male_tanktop_jeans.mdl" then
        self:SetBodygroup(0,math.random(0,3))
        self:SetBodygroup(1,math.random(0,6))
        self:SetSkin(math.random(0,1))

    elseif self:GetModel() == "models/darkborn/l4d2/common/common_male_tshirt_cargos.mdl" then
