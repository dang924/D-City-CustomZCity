...
local function velocityDamage(ent, data)
	...
	local hiddenLeapProtected = (IsValid(owner) and owner:IsPlayer() and round and round.name == "hidden" and owner:Team() == 0 and (owner.HiddenLeapImpactProtectUntil or 0) > CurTime()) or (ZC_IsSubject617LeapProtected and ZC_IsSubject617LeapProtected(owner))
