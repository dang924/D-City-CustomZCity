...
hg.armor.torso = {
	["vest9"] = { --models/eft_props/gear/armor/ar_6b2.mdl
		"torso",
	...
	["vest13"] = {
		"torso",
		"models/eft_props/gear/armor/cr/cr_m2.mdl",
		Vector(0, 3.1, 0),
		Angle(0, 90, 90),
		protection = 7.5,
		bone = "ValveBiped.Bip01_Spine2",
		model = "models/eft_props/gear/armor/cr/cr_m2.mdl",
		femPos = Vector(-1, 0, 1.2),
		scale = 0.88,
		femscale = 0.8,
		effect = "Impact",
	...
	["vest14"] = {
		"torso",
		"models/eft_props/gear/armor/cr/cr_strandhogg.mdl",
		Vector(0, 3.1, 0),
		Angle(0, 90, 90),
		protection = 14.5,
		bone = "ValveBiped.Bip01_Spine2",
	...
	["vest17"] = {
		"torso",
		"models/eft_props/gear/armor/ar_beetle3.mdl",
		Vector(0, 3.1, 0),
		Angle(0, 90, 90),
		protection = 8,
		bone = "ValveBiped.Bip01_Spine2",
	...
	["vest19"] = { 
		"torso",
		"models/eft_props/gear/armor/cr/cr_m1.mdl",
		Vector(-0.4, 2.9, 0),
		Angle(0, 92, 90),
		protection = 11,
		bone = "ValveBiped.Bip01_Spine2",
		model = "models/eft_props/gear/armor/cr/cr_m1.mdl",
		femPos = Vector(-1.5, 0, 1.5),
		scale = 0.9,
		femscale = 0.82,
		effect = "Impact",
	...
	["vest22"] = { 
		"torso",
		"models/eft_props/gear/armor/cr/cr_tv115.mdl",
		Vector(-0.4, 2.9, 0),
		Angle(0, 92, 90),
		protection = 12,
		bone = "ValveBiped.Bip01_Spine2",
	...
	["vest26"] = { 
		"torso",
		"models/eft_props/gear/armor/ar_slick_t.mdl",
		Vector(-0.4, 2.9, 0),
		Angle(0, 92, 90),
		protection = 11.3,
		bone = "ValveBiped.Bip01_Spine2",
		model = "models/eft_props/gear/armor/ar_slick_t.mdl",
		femPos = Vector(-1.5, 0, 1.5),
		scale = 0.9,
		femscale = 0.82,
		effect = "Impact",
	...
	["vest27"] = { 
		"torso",
		"models/eft_props/gear/armor/ar_trooper.mdl",
		Vector(-0.4, 2.9, 0),
		Angle(0, 92, 90),
		protection = 12,
		bone = "ValveBiped.Bip01_Spine2",
		model = "models/eft_props/gear/armor/ar_trooper.mdl",
		femPos = Vector(-1.5, 0, 1.5),
		scale = 0.9,
		femscale = 0.82,
		effect = "Impact",
	...
	["vest32"] = { 
		"torso",
		"models/eft_props/gear/armor/cr/cr_crye_avs.mdl",
		Vector(-0.4, 2.9, 0),
		Angle(0, 92, 90),
		protection = 13.5,
		bone = "ValveBiped.Bip01_Spine2",
		model = "models/eft_props/gear/armor/cr/cr_crye_avs.mdl",
		femPos = Vector(-1.5, 0, 1.5),
		scale = 0.9,
		femscale = 0.82,
		effect = "Impact",
	...
	["vest33"] = { 
		"torso",
		"models/eft_props/gear/armor/cr/cr_carrier_tactec.mdl",
		Vector(-0.4, 2.9, 0),
		Angle(0, 92, 90),
		protection = 14,
		bone = "ValveBiped.Bip01_Spine2",
		model = "models/eft_props/gear/armor/cr/cr_carrier_tactec.mdl",
		femPos = Vector(-1.5, 0, 1.5),
		scale = 0.9,
		femscale = 0.82,
		effect = "Impact",
...
hg.armor.head = {
    ...
    ["helmet8"] = {
		customviewrender = function(ply)
			DrawFirstPersonHelmet(ply, "models/eft_props/gear/helmets/helmet_6b47_cover.mdl", vectors[4], 0)
		end,
		"head",
	...
	["helmet9"] = {
		customviewrender = function(ply)
			DrawFirstPersonHelmet(ply, "models/eft_props/gear/helmets/helmet_6b47.mdl", vectors[4], 0)
		end,
		"head",
	...
	["helmet11"] = {
		"head",
		"models/eft_props/gear/helmets/helmet_tsh_4m2.mdl",
		Vector(2.2,-1, 0),
		Angle(180, 100, 90),
		protection = 2,
		bone = "ValveBiped.Bip01_Head1",
	...
	["helmet15"] = {
		"head",
		"models/eft_props/gear/helmets/helmet_mich2002.mdl",
		Vector(2.2,-0.5, 0),
		Angle(180, 100, 90),
		protection = 11,
		bone = "ValveBiped.Bip01_Head1",
		model = "models/eft_props/gear/helmets/helmet_mich2002.mdl",
		femPos = Vector(-1, 0, 0.1),
		norender = true,
		effect = "Impact",
		surfaceprop = 67,
	...
	["helmet16"] = {
		"head",
		"models/eft_props/gear/helmets/helmet_sphera_c.mdl",
		Vector(2.2,-1, 0),
		Angle(180, 100, 90),
		protection = 11,
		bone = "ValveBiped.Bip01_Head1",
	...
	["helmet22"] = {
		"head",
		"models/eft_props/gear/helmets/helmet_nfm_hjelm.mdl",
		Vector(2.7,-0.7, 0),
		Angle(180, 100, 90),
		protection = 8,
		bone = "ValveBiped.Bip01_Head1",
		model = "models/eft_props/gear/helmets/helmet_nfm_hjelm.mdl",
		femPos = Vector(-1, 0, 0.1),
		norender = true,
		effect = "Impact",
		surfaceprop = 67,
	...
	["helmet24"] = {
		"head",
		"models/gruchk/jmod_dayz/helmets/ht_helohelmet.mdl",
		Vector(4,-0.1, 0),
		Angle(180, 100, 90),
		protection = 4,
		bone = "ValveBiped.Bip01_Head1",
		model = "models/gruchk/jmod_dayz/helmets/ht_helohelmet.mdl",
		femPos = Vector(-1, 0, 0.1),
		norender = true,
		effect = "Impact",
		surfaceprop = 67,
...
hg.armor.ears = {
    ...
    ["headphones2"] = {
		"ears",
		"models/eft_props/gear/headsets/headset_m32.mdl",
		Vector(2.2, -0.6, 0),
		Angle(180, 100, 90),
		protection = 0,
		bone = "ValveBiped.Bip01_Head1",
		...
		SoundlevelAdd = 15,
		VolumeAdd = 0.15,
		NormalizeSnd = {0.8,0.15}
	},
	["headphones3"] = {
		"ears",
		"models/eft_props/gear/headsets/headset_comtacii.mdl",
		Vector(2.2, -0.6, 0),
		Angle(180, 100, 90),
		protection = 0,
		bone = "ValveBiped.Bip01_Head1",
		model = "models/eft_props/gear/headsets/headset_comtacii.mdl",
		femPos = Vector(-0.5, 0, 1),
		norender = true,
		viewmaterial = Material("sprites/mat_jack_hmcd_helmover"),
		effect = "Impact",
		...
		SoundlevelAdd = 15,
		VolumeAdd = 0.3,
		NormalizeSnd = {0.65,0.3}
	},
	["headphones4"] = {
		"ears",
		"models/eft_props/gear/headsets/headset_gsh01.mdl",
		Vector(2.2, -0.6, 0),
		Angle(180, 100, 90),
		protection = 0,
		bone = "ValveBiped.Bip01_Head1",
		model = "models/eft_props/gear/headsets/headset_gsh01.mdl",
		femPos = Vector(-0.5, 0, 1),
		norender = true,
		viewmaterial = Material("sprites/mat_jack_hmcd_helmover"),
		effect = "Impact",
...
local armorNames = {
	...
	["vest30"] = "ARMA-18 Vest",
	["vest31"] = "ARSCPC Vest",
	["vest32"] = "AVS Military Carrier Vest",
	["vest33"] = "TacTec Carrier",
	["vest28"] = "Korund Armor Plate",
	["helmet17"] = "Helmet Mid Ages",
	["helmet18"] = "Bastion Helmet",
	["helmet19"] = "Ops Core Fast Tan",
	["helmet20"] = "Ulach Tan",
	["helmet21"] = "Ulach Black",
	["helmet22"] = "Hjelm",
	["helmet23"] = "Ops Core Fast Black",
	["helmet24"] = "Airborne Pilot Helmet",
	["vest25"] = "Chest Plate Mid Ages",
	["vest26"] = "Slick Tan Armor Vest",
	["vest27"] = "USEC Trooper Armor Plate",
	["helmet16"] = "Sphera-S",
	["helmet15"] = "Mich 2002",
	["helmet14"] = "Mich 2001",
	["helmet13"] = "MF-UNTAR Helmet",
	["helmet12"] = "Altyn",
	["helmet11"] = "4M2 Tank Helmet",
	["helmet10"] = "LSZH",
	["helmet9"] = "6B47",
	["helmet8"] = "6B47 EMR",
	...
	["vest14"] = "Strandhogg",
	["vest15"] = "TV110",
	["vest16"] = "Plate Carrier TTSK",
	["vest17"] = "Press Zhuk Vest",
	["vest18"] = "Shellback Tactical Banshee",
	["headphones2"] = "M32",
	["headphones3"] = "Comtac II",
	["headphones4"] = "GSH-01",
	["vest19"] = "RGF M1",
	["vest20"] = "Osprey Defense Vest",
	["vest21"] = "Bagariy Russian Gear",
	["vest22"] = "TV-115 Bear Vest",
	["vest23"] = "6B5",
	["vest24"] = "Zhuk Vest",
}
hg.armorNames = armorNames
local armorIcons = { --entities/ent_jack_gmod_ezarmor_greathelm.png
	["helmet24"] = "entities/ent_jack_gmod_ezarmor_helohelm.png",
	["helmet17"] = "entities/ent_jack_gmod_ezarmor_greathelm.png",
	["helmet18"] = "entities/ent_jack_gmod_ezarmor_bastion.png",
	["helmet19"] = "entities/ent_jack_gmod_ezarmor_fastmttan.png",
	["helmet20"] = "entities/ent_jack_gmod_ezarmor_ulachcoyote.png",
	["helmet21"] = "entities/ent_jack_gmod_ezarmor_ulach.png",
	["helmet22"] = "entities/ent_jack_gmod_ezarmor_hjelm.png",
	["helmet23"] = "entities/ent_jack_gmod_ezarmor_fastmtblack.png",
	["vest25"] = "entities/ent_jack_gmod_ezarmor_chestplate.png",
	["vest33"] = "entities/ent_jack_gmod_ezarmor_tactec.png",
	["vest32"] = "entities/ent_jack_gmod_ezarmor_cryeavs.png",
	["vest31"] = "entities/ent_jack_gmod_ezarmor_aacpc.png",
	["vest30"] = "entities/ent_jack_gmod_ezarmor_arsarmaa18.png",
	["vest29"] = "entities/ent_jack_gmod_ezarmor_eaimbss.png",
	["vest28"] = "entities/ent_jack_gmod_ezarmor_korundvm.png",
	["vest27"] = "entities/ent_jack_gmod_ezarmor_trooper.png",
	["vest26"] = "entities/ent_jack_gmod_ezarmor_slicktan.png",
	["vest24"] = "entities/ent_jack_gmod_ezarmor_zhuk6a.png",
	["vest23"] = "entities/ent_jack_gmod_ezarmor_6b516.png",
	["vest22"] = "entities/ent_jack_gmod_ezarmor_tv115.png",
	["vest21"] = "entities/ent_jack_gmod_ezarmor_bagariy.png",
	["vest20"] = "entities/ent_jack_gmod_ezarmor_ospreyprotec.png",
	["vest19"] = "entities/ent_jack_gmod_ezarmor_m1.png",
	["helmet16"] = "entities/ent_jack_gmod_ezarmor_sferas.png",
	["helmet15"] = "entities/ent_jack_gmod_ezarmor_mich2002.png",
	["helmet14"] = "entities/ent_jack_gmod_ezarmor_mich2001.png",
	["helmet13"] = "entities/ent_jack_gmod_ezarmor_untarhelm.png",
	["helmet12"] = "entities/ent_jack_gmod_ezarmor_altyn.png",
	["mask5"] = "entities/ent_jack_gmod_ezarmor_gp5.png",
	["mask4"] = "entities/ent_jack_gmod_ezarmor_gp7.png",
	["helmet11"] = "entities/ent_jack_gmod_ezarmor_shlemofon.png",
	["helmet10"] = "entities/ent_jack_gmod_ezarmor_lshz.png",
	["helmet9"] = "entities/ent_jack_gmod_ezarmor_6b47.png",
	["helmet8"] = "entities/ent_jack_gmod_ezarmor_6b47chehol.png",
	["headphones4"] = "entities/ent_jack_gmod_ezarmor_gssh01.png",
	["vest18"] = "entities/ent_jack_gmod_ezarmor_banshee.png",
	["vest17"] = "entities/ent_jack_gmod_ezarmor_zhukpress.png",
	["vest16"] = "entities/ent_jack_gmod_ezarmor_ttsk.png",
	["vest15"] = "entities/ent_jack_gmod_ezarmor_tv110.png",
	["vest14"] = "entities/ent_jack_gmod_ezarmor_strandhogg.png",
	["vest13"] = "entities/ent_jack_gmod_ezarmor_m2.png",
	...
	["vest9"] = "entities/ent_jack_gmod_ezarmor_6b2.png",
	["vest10"] = "entities/ent_jack_gmod_ezarmor_6b13.png",
	["vest11"] = "entities/ent_jack_gmod_ezarmor_6b13m.png",
	["vest12"] = "entities/ent_jack_gmod_ezarmor_iotvvest.png",
	["headphones2"] = "entities/ent_jack_gmod_ezarmor_m32.png",
	["headphones3"] = "entities/ent_jack_gmod_ezarmor_comtac.png",
}
